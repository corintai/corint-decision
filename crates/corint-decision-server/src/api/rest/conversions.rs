...
//!
//! Functions to convert between CORINT `Value` and serde_json::Value,
//! and other conversion utilities.

use corint_decision_engine::{ScoreNormalizer, Value};

/// Normalize raw score to canonical 0-1000 range using sigmoid/logistic function
///
/// Uses the engine's ScoreNormalizer with default parameters for industry-standard
...
/// Convert CORINT `Value` to serde_json::Value
...
/// Convert serde_json::Value to CORINT `Value`

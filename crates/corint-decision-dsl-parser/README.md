...
`corint-decision-dsl-parser` converts YAML rule definitions into Abstract Syntax Tree (AST) representations. It handles the parsing of rules, rulesets, pipelines, features, and registry configurations.
...
└─────────────┬───────────────────────┘
              ...
              ▼
┌─────────────────────────────────────┐
│   AST (corint-decision-model types)          │
...
- `corint-decision-model`: AST type definitions

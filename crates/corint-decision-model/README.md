...
`corint-decision-model` provides the fundamental building blocks used across the CORINT ecosystem:
...
```rust
use corint_decision_model::ast::{Rule, WhenBlock, Expression, Operator};
use corint_decision_model::Value;

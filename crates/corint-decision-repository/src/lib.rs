...
//! use corint_decision_repository::{Repository, WritableRepository, PostgresRepository};
//!
//! # #[cfg(feature = "postgres")]
//! #[tokio::main]
//! async fn main() -> anyhow::Result<()> {
...
//!
//! ```no_run
//! use corint_decision_repository::{Repository, CacheableRepository, FileSystemRepository};
//!
//! #[tokio::main]
//! async fn main() -> anyhow::Result<()> {
...
//! ```no_run
//! # #[cfg(feature = "postgres")]
//! use corint_decision_repository::{WritableRepository, PostgresRepository};
//!
//! # #[cfg(feature = "postgres")]
//! #[tokio::main]
//! async fn main() -> anyhow::Result<()> {
...
//! - [crates/corint-decision-repository/README.md](https://github.com/corint/corint-decision/blob/main/crates/corint-decision-repository/README.md) - Complete repository API documentation
